...
def calculate_voxel_size(points, target_size_mb=20):
    """Calculate the voxel size to downsample the point cloud to approximately 20 MB."""
...
def downsample_pointcloud(input_file, target_size_mb=20):
    """Downsample a point cloud to approximately 20 MB."""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Downsample a point cloud to approximately 20 MB.")
